...
%\usepackage[giveninits=true,dashed=false,isbn=false,doi=false,maxbibnames=99,maxcitenames=2,uniquelist=false,uniquename=false,url=false,date=year,annotation]{biblatex-chicago}

\usepackage[bibstyle=authoryear,citestyle=authortitle,giveninits=true,dashed=false,isbn=false,doi=false,eprint=false,maxbibnames=99,maxcitenames=2,uniquelist=false,uniquename=false,url=false,date=year]{biblatex}
